...
class Case2Dtest_receiverdensity(Case2Dtest):
    name = "Case2Dtest_receiverdensity"
    ...
    def set_case(self):
        ...
        acquire.dg = 1
        acquire.ds = 20
        acquire.gmin = 20 * acquire.dg
        acquire.gmax = model.NX - acquire.gmin

        return model, acquire, label


class Case1Dtest_sourcedensity(Case):
    name = "Case1Dtest_sourcedensity"
    ...
    def set_case(self):
        ...
        model.NX = 300
        model.NZ = 150
        model.water_dmin = 600
        model.water_dmax = 800
        model.layer_num_min = 3
        model.layer_dh_min = 20
        model.layer_dh_max = 30

        acquire = Acquisition(model=model)
        acquire.NT = 2560
        acquire.dg = 5
        acquire.gmin = 4 * acquire.dg
        acquire.gmax = model.NX - acquire.gmin
...
class Case1Dtest_complexity(Case1Dtest_sourcedensity):
    name = "Case1Dtest_complexity"
    ...
    def set_case(self):
        ...
        model.water_dmin = 500
        model.water_dmax = 700
        model.layer_num_min = 8
        model.layer_dh_min = 10
        model.layer_dh_max = 40

        return model, acquire, label


class Case2Dtest_sourcedensity(Case1Dtest_sourcedensity):
    name = "Case2Dtest_sourcedensity"
...
class Case2Dtest_complexity(Case1Dtest_complexity):
    name = "Case2Dtest_complexity"
