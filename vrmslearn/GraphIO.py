...
class GraphOutput:
    ...
    def generate(self, props):
        """
        Output the labels and weights for modelling a particular dataset.

        From a dict of properties, the labels are generated by this function.
        The labels can be saved in a format and later transformed by
        `GraphOutput.preprocess` if the training requires a modification of the
        label.
...
class ShotGather(GraphInput):
    ...
    def __init__(self,
        ...
        """
        Define parameters controling the preprocessing.

        :param acquire: An `Acquisition` object controlling data creation.
        :param model: A `BaseModelGenerator` object.
